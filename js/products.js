...
const products = [
    ...
    },
    {
        ...
        originalPrice: 700,
        discount: 14,
        description: "Affordable, chemical-free, and toxin-free face wash with rice water extracts. This eco-friendly product is specially formulated to target Bangladeshi skin problems while maintaining premium quality.",
        ingredients: "Water, Rice Extract, Glycerin, Sodium Cocoyl Isethionate, Vitamin E, Aloe Vera Extract, Coconut Oil Derivatives",
        howToUse: "Apply a small amount to damp face and work into a lather. Massage in circular motions and rinse thoroughly with water.",
        size: "100ml",
        sku: "ME-RW-FW-004",
        category: "Cleanser",
